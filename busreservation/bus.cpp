...
cout<<"                                      \\ \\  ";*/
gotoxy(i,9);
cout<<"       รรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรยป";
gotoxy(i,10);
cout<<"       บ        LOURA BUS SERVICE           บรยป";
gotoxy(i,11);
cout<<"       รรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรรยนรยผ";
gotoxy(i,12);
cout<<"       บ  รรรรยป   รรรรป   รรรยป   รรรรยป     บ";
gotoxy(i,13);
cout<<"      /บ  รรรรยผ   รรรรยผ   รรรรยผ   รรรรยผ     บรยป";
gotoxy(i,14);
cout<<"     บ บ   - - - - - - - - - - - - - - - -  บ บ";
gotoxy(i,15);
cout<<"      \\บ                                    บรยผ ";
gotoxy(i,16);
cout<<"       บ    LOURA TRANSPORT      บ";
gotoxy(i,17);
cout<<"       |||||||||||||||||||||||||||||||||||||ยผ";
gotoxy(i,18);
cout<<"           \\____/               \\____/    ";
...
{           back3:
		...
		back1:
		cout<<"\nENTER THE ROUTE CODE BETWEEN 1 TO 5  ===ฏ " ;
		cin>>c1;
		if(c1<1||c1>5)
		{cout<<"\n WRONG ENTRY";
		goto back1;
...
void customer :: out()
{
	cout<<"\n\t\tCUSTOMER NAME ===ฏ "<<name;
	cout<<"\n\t\tCUSTUMER ADDRESS ===ฏ "<<address;
	cout<<"\n\t\tPHONE NO ===ฏ "<<phone;
	cout<<"\n\t\tALLOTED SEAT NO. ===ฏ"<<seat_no1;
 }
	 ...
	 do
	      ...
	      if(found==1)
		{
		 ...
		 file.close();
		  ...
		  cout<<"\nDo you wish to reserve another ticket/?  Y/N  ===ฏ ";
		  cin>>v;
       }
       while(v=='y'||v=='Y');
...
void buses :: out1()
{
  cout<<"\nROUTE CODE ===ฏ "<<code<<"\t\tSEAT NO ===ฏ "<<seat_no;
}
